"""
Django settings for tourist_archive project.
...
# SECURITY WARNING: keep secret key as secret, dont use denug and specify allowed host before putting to production!!!
...
WSGI_APPLICATION = 'tourist_archive.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis',  # https://docs.djangoproject.com/en/4.0/ref/contrib/gis/tutorial/#setting-up
